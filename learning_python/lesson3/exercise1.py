...
with open("show_vlan.txt") as f:
    show_vlan = f.read()
print(show_vlan)                                    #this print is for testing actually no need.
print()                                             #this print is for testing actually no need.
print ("*" * 80 )                                   #this print is for testing actually no need.
for line in show_vlan.splitlines():                 #把斷行去除。
    # Skip certain lines
    ...
    print(fields)                                   #this print is for testing actually no need.
print ("*" * 80 )                                   #this print is for testing actually no need.
print()
pprint(vlan_list)
print()
